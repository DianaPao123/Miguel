    ...
    public partial class wfrClientes : System.Web.UI.Page
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    cliente = client.GetCliente(idCliente);
                    clientes modCliente = this.GetClient(cliente);
        ...
        private clientes GetClient(clientes cliente)
        {
            ...
            cliente.RFC = this.txtRFC.Text;
                ...
                cliente.Ciudad = this.txtMunicipio.Text;
                cliente.Estado = this.txtEstado.Text;
                cliente.Pais = this.txtPais.Text;
                cliente.CP = this.txtCP.Text;
                // Telefonos = this.txtTelefono.Text,
