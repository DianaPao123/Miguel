...
namespace GAFWEB
{
    public partial class wfrFacturasConsulta : System.Web.UI.Page
    {
        ...
        protected void gvFacturas_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            ...
            this.gvFacturas.DataBind();
            this.CalculaTotales(ViewState["facturas"] as List<vfacturasContabilidad>);
        ...
        private void FillView()
        {
          ...
          //  var cliente = NtLinkClientFactory.Cliente();
            ...
            using (factu as IDisposable)
            {
                ...
                var ventas =  factu.GetListContabilidad(ddlLinea.SelectedValue, fechaInicial, fechaFinal, int.Parse(this.ddlEmpresas.SelectedValue), filtro,
        ...
        private void CalculaTotales(List<vfacturasContabilidad> lista)
        {
