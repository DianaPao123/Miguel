<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="wfrPagoConsultaRechazadosAceptados.aspx.cs" Inherits="GAFWEB.wfrPagoConsultaRechazadosAceptados" %>
        	...
        	<asp:BoundField HeaderText="FormaPago" DataField="FormaPago"  />
          	<asp:BoundField HeaderText="Total Factura" DataField="Total" DataFormatString="{0:C}" ItemStyle-HorizontalAlign="Right" />
                <asp:BoundField HeaderText="Promotor" DataField="nombreUsuario" />
                  <asp:BoundField HeaderText="Estatus" DataField="pagoVerificado" />
