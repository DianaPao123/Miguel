...
namespace GAFWEB
{
    public partial class wfrPagosConsulta : System.Web.UI.Page
    {
        ...
        protected Boolean IsOverAgeLimit(int Age) 
        {
            if (Age == -1)
                return false;
            else
        ...
        protected void gvFacturas_RowCommand(object sender, GridViewCommandEventArgs e)
        {
                ...
                if (e.CommandName.Equals("Pagar"))
            {
               ...
               // this.mpePagarPreFactura.Show();
                ...
                {  
                   ...
                   this.lblFecha.Text = "<b>" + this.lblFecha.Text + "</b>" + PAGOPRo.fecha;
                   this.lblBanco.Text = "<b>" + this.lblBanco.Text + "</b>" + PAGOPRo.Banco;
                   this.lblMonto.Text = "<b>" + this.lblMonto.Text + "</b>" + PAGOPRo.Monto;
            ...
            if (e.CommandName.Equals("Rechazado"))
            {
               ...
               if (e.CommandName.Equals("Editarx"))
            {
              //  var id = Convert.ToInt32(e.CommandArgument);
                  var id = this.gvFacturas.DataKeys[Convert.ToInt32(e.CommandArgument)].Values["idPreFactura"];
                  Response.Redirect("wfrPrePagos.aspx?idPrefactura=" + id);
                   ...
                   if (e.CommandName.Equals("Editar"))
                   {
                       ...
                       //  var id = this.gvFacturas.DataKeys[Convert.ToInt32(e.CommandArgument)].Values["idPreFactura"];
                       //   var id = 0;
                       Response.Redirect("wfrPagos.aspx?id=" + id);
                   }
        ...
        private void FillView()
        {
            ...
            if (!string.IsNullOrEmpty(this.ddlClientes.SelectedValue))
                using (factu as IDisposable)
                {
                    ...
                    var ventas = factu.GetListPagoPrefactura( fechaInicial, fechaFinal, int.Parse(this.ddlEmpresas.SelectedValue), filtro,
        ...
        protected void gvFacturas_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (e.Row.Cells[7].Text == "&nbsp;" || string.IsNullOrEmpty(e.Row.Cells[7].Text))
                    e.Row.Cells[7].Text = "Pendiente por Revisar";
                if (e.Row.Cells[7].Text == "1")
                    e.Row.Cells[7].Text = "Validado";
                   if (e.Row.Cells[7].Text == "2")
                    e.Row.Cells[7].Text = "Pagada";
                if (e.Row.Cells[7].Text == "-1")
                    e.Row.Cells[7].Text = "Rechazado";
