...
namespace GAFWEB
{
    public partial class wfrClientesConsulta : Page
    {
        ...
        protected void gvClientes_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if(e.CommandName.Equals("EditarCliente"))
            {
                ...
                if (key != null)
                {
                    ...
                    Response.Redirect("wfrClientesNuevos.aspx?idClientePromotor=" + idClientePromotor);
                }
            }
        ...
        {
            this.Response.Redirect("wfrClientesNuevos.aspx?idCliente=0");
        }
        ...
        private void GetClientes()
        {
            ...
            using (cliente as IDisposable)
            {
                var clientes = cliente.GetClientePromotorAllX( txtBusqueda.Text);
