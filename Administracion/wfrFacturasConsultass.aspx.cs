...
namespace GAFWEB
{
    public partial class wfrFacturasConsultass : System.Web.UI.Page
    {
            ...
            else if (e.CommandName.Equals("Acuse"))
            {
                try
                {
                    ...
                    using (cliente as IDisposable)
                    {
                        ...
                        //---------------
                        string sal = fac.GetConsultaEstatusCFDI(cadena);
        ...
        private void FillView()
        {
          ...
          //  var cliente = NtLinkClientFactory.Cliente();
            ...
            using (factu as IDisposable)
            {
                ...
                var ventas =  factu.GetList(fechaInicial, fechaFinal, int.Parse(this.ddlEmpresas.SelectedValue), filtro,
