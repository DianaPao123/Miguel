...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div style="height:100%; overflow-y: scroll;>
        ...
        <asp:GridView ShowFooter="True" runat="server"  CssClass="style124" 
            ID="gvFacturas" AutoGenerateColumns="False" DataKeyNames="idDevoluciones"
		...
		<Columns>
			<asp:BoundField HeaderText="Solicitud" DataField="idDevoluciones" />
        	...
        	<asp:BoundField HeaderText="Pendiente" DataField="Pendiente" DataFormatString="{0:C}" ItemStyle-HorizontalAlign="Right" />
