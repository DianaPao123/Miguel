    ...
    public partial class wfrUsuariosConsulta : Page
    {
        ...
        protected void gvClientes_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if(e.CommandName.Equals("EditarCliente"))
            {
                ...
                if (key != null)
                {
                    int idUsuario = Convert.ToInt32(key.Value);
                    Response.Redirect("wfrUsuarios.aspx?idUsuario=" + idUsuario);
                }
            }
                /*
        ...
        {
            this.Response.Redirect("wfrUsuarios.aspx?idUsuario=0");
        }
        ...
        private void GetClientes()
        {
            ...
            using (cliente as IDisposable)
            {
                var clientes = cliente.GetListPromotorOperador(txtBusqueda.Text);
