...
namespace GAFWEB
{
    public partial class wfrFacturaLineaB : Page
    {
          ...
          //            lblLinea.Visible = false;
                  ...
                  using (Empresa as IDisposable)
                  {
                    ...
                    //  this.ddlEmpresa.DataSource = Empresa.GetListempresa();
                      this.ddlEmpresa.DataSource = Empresa.GetListForLine(ddlLinea.SelectedValue).Where(p => p.RFC == "MLM170606UZA" || p.RFC == "CBR180430LR8" || p.RFC == "SAS1204131Z5" || p.RFC == "CTO1804204G8");
        ...
        */
        ...
        private List<clientes> llenadoClientesEspacial(List<clientes> clientess)
        {
            ...
            DatosClientesEspecial lc13 = new DatosClientesEspecial(); lc13.nombre = "MIGUEL GARCIA EVARISTO"; lc13.rfc = "MIGE591026QMA"; ListaCliente.Add(lc13);
     ...
     //       DatosClientesEspecial lc77 = new DatosClientesEspecial(); lc77.nombre = "CONSULTORIA BRADFORD, S.A. DE C.V."; lc77.rfc = "CBR180430LR8"; ListaCliente.Add(lc77);
