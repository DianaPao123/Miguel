<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="wfrPreFactura.aspx.cs" Inherits="GAFWEB.wfrPreFactura" %>
...
<asp:UpdatePanel ID="up1" runat="server"  UpdateMode="Conditional" >
    <ContentTemplate>
            ...
            <div class ="card-body">
                ...
                <div class = "row"> <%--Serie/Folio/Sucursal--%>
                    ...
                    <div>
                        ...
                        <asp:TextBox ID="txtPreFolio" runat="server" Enabled="False" CssClass="form-control" Visible="false"/>
                ...
                <div class = "row"> <%--Uso/Observaciones--%>
                    <div class = "form-group col-md-6 col-sm-12">
                        ...
                        <asp:DropDownList ID="ddlUsoCFDI" runat="server"  AppendDataBoundItems="True"
                         AutoPostBack="True" CssClass="form-control" 
                            onselectedindexchanged="ddlUsoCFDI_SelectedIndexChanged">
        ...
        <div class = "card mt-2"> 
            ...
            <div class = "card-body">
                <div class = "row"> <%--Clave Unidad/No. Identificación--%>
                    <div class = "form-group col-md-9">
                        ...
                        DataPlaceHolder="Escriba aquí..." 
                            ...
                            CssClass="form-control" AutoPostBack="True"  width="400px" 
                ...
                <div class = "row"> <%--Cantidad/Unidad/Descuento--%>
                    ...
                    <%--<div class = "form-group col-md-4 col-sm-6">
                     ...
                     <asp:CheckBox runat="server" ID="cbIVARet" Text="RetIVA" AutoPostBack="True" Checked="False" Visible="false" CssClass="form-control" />
                    </div>
         ...
         <div class = "card mt-2" id="DivDPagos" runat="server" > 
            <div class = "card-header">
                Pago
            </div>
            <div class = "card-body">
                ...
                <div class = "form-group col-md-4 col-sm-6">
                        ...
                        <asp:TextBox ID="txtFechaPagoD" runat="server" CssClass="form-control"/>
                        <asp:CalendarExtender ID="CalendarExtender1" runat="server" Format="dd/MM/yyyy" 
                        PopupButtonID="txtFechaPagoD" TargetControlID="txtFechaPagoD"  />
                        <asp:CompareValidator ID="CompareValidator3" runat="server" ControlToValidate="txtFechaPagoD" Display="Dynamic" 
                        ErrorMessage="* Fecha Invalida" ForeColor="Red" Operator="DataTypeCheck" Type="Date" ValidationGroup="AgregarDPago" />
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ControlToValidate="txtFechaPagoD" 
                        Display="Dynamic" ErrorMessage="Requerido" ForeColor="Red" ValidationGroup="CrearFactura"></asp:RequiredFieldValidator>
                    </div>

                    <div class = "form-group col-md-4 col-sm-6">
                       <asp:Label ID="Label23" runat="server" Text="Banco:"></asp:Label>
                        <asp:DropDownList ID="ddlBancoPago" runat="server" CssClass="form-control">
                           ...
                           <asp:ListItem runat="server" Text="MIFEL" Value="MIFEL" />
                            <asp:ListItem runat="server" Text="MULTIVA" Value="MULTIVA" />
                             ...
                             <asp:ListItem runat="server" Text="SCOTIABANK" Value="SCOTIABANK" />
                              <asp:ListItem runat="server" Text="BANBAJIO" Value="BANBAJIO" />
                        </asp:DropDownList>
                        </div>
                    <div class = "form-group col-md-4 col-sm-6">
                        ...
                        TargetControlID="txtMontoPago" ValidChars="." /> 
                        ...
                        ValidationGroup="CrearFactura" />
                           <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="txtMontoPago" 
                        Display="Dynamic" ErrorMessage="Requerido" ForeColor="Red" ValidationGroup="CrearFactura"></asp:RequiredFieldValidator>
