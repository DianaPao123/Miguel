<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="wfrFacturasConsultaB.aspx.cs" Inherits="GAFWEB.wfrFacturasConsultaB" %>
...
--%>	
 ...
 <asp:BoundField HeaderText="MontoPago" DataField="Monto" DataFormatString="{0:C}" ItemStyle-HorizontalAlign="Right" />
	...
	--%>		<%--<asp:BoundField HeaderText="Status" DataField="StatusFactura"/>--%>
           ...
           <asp:BoundField HeaderText="Operador" DataField="promotor" />
