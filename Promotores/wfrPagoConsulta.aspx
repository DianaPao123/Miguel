...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="card mt-2">   
          ...
          <div class = "col-2 float-right">
           ...
           onselectedindexchanged="ddlLinea_SelectedIndexChanged" >
                   ...
                   <div class="row mt-2">
         <div class = "col-2 justify-content-end"><asp:Label ID="Label3" runat="server" Text="Empresa:" CssClass="form-text"></asp:Label></div>
         <div class = "col-3 ">
		...
		AppendDataBoundItems="True" DataValueField="idEmpresa" onselectedindexchanged="ddlEmpresas_SelectedIndexChanged" />
              ...
              <div class="row mt-2">
         <div class = "col-2 justify-content-end"><asp:Label ID="Label4" runat="server" Text="Fecha Inicial:" CssClass="form-text"></asp:Label></div>
           <div class = "col-3 ">
        ...
        <div class = "col-2 justify-content-end"><asp:Label ID="Label5" runat="server" Text="Fecha Final:" CssClass="form-text"></asp:Label></div>
            <div class = "col-3 ">
               ...
               <div class="row mt-2">
                <div class = "col-2 float-right">
                       <asp:Label ID="Label6" runat="server" Text="Clientes:" CssClass="form-text"></asp:Label>
 			</div>
                       <div class = "col-2">
   ...
   <asp:ButtonField ButtonType="Link" Text="Editar" CommandName="Editarx" />
      ...
      <%--     <asp:ButtonField ButtonType="Link" Text="Generar"  CommandName="GenerarCFDI"   />
          <asp:ButtonField ButtonType="Link" Text="PDF" CommandName="DescargarPdf" />
       	...
       	--%>	
             ...
             <%--     <asp:ButtonField  ButtonType="Link" Text="Aplicar" CommandName="Editar" />--%>
                    <asp:TemplateField  HeaderText="Aplicar">
                <ItemTemplate>
                    <asp:Button class="btn btn-outline-primary"   runat="server" Text='<%# (int)Eval("pagoVerificado") == -1 ? "Rechazado" : " Aplicar "  %>'  CommandName='<%# (int)Eval("pagoVerificado") == -1 ? "Rechazado" : "Editar"  %>' ID="btnCancelarf" CommandArgument='<%#Eval("idPreFactura") %>'  />
                 </ItemTemplate>
            </asp:TemplateField>
 ...
 <%--       <asp:ModalPopupExtender runat="server" ID="mpeCancelar" TargetControlID="btnCancelarDummy" 
              BackgroundCssClass="mpeBack" CancelControlID="btnCerrarPagar" PopupControlID="pnlCancelar"/>

	<asp:Panel runat="server" ID="pnlCancelar" CssClass="page2" BackColor="White" Width="600px"
        Height="300px" style="text-align: center;">
       ...
       <Triggers>
           ...
           <asp:PostBackTrigger ControlID="gvFacturas" />
            ...
            <asp:ModalPopupExtender runat="server" ID="mpeCancelar" TargetControlID="btnEmailDummy" BackgroundCssClass="mpeBack"
