<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="wfrPrefacturaConsultaDevolucion.aspx.cs" Inherits="GAFWEB.wfrPreFacturasConsultaDevolucion" %>
...
<%--
            <asp:HiddenField ID="TotalCliente" runat="server" />
            <asp:HiddenField ID="TotalPromotor" runat="server" />
            <asp:HiddenField ID="TotalEmpresa" runat="server" />
            <asp:HiddenField ID="TotalContacto" runat="server" />--%>
    ...
    <div style="height:100%; overflow-y: scroll;>
        ...
        <asp:GridView ShowFooter="True" runat="server"  CssClass="style124" 
            ID="gvFacturas" AutoGenerateColumns="False" DataKeyNames="idEmpresa,idCliente,idPreFactura,DTPromotor,DTCliente,DTEmpresa,DTContacto"
		...
		<Columns>
         ...
         <asp:TemplateField  HeaderText="Seleccionar" ItemStyle-HorizontalAlign="Center">
                  <ItemTemplate> 
                    ...
                    <asp:CheckBox ID="cbSelecion" runat="server"  oncheckedchanged="cbSelecion_CheckedChanged" />
                </ItemTemplate>
            </asp:TemplateField>
		</Columns>
	</asp:GridView> 
    ...
    <br />
    <asp:Button runat="server" ID="btnLlenar" Text="Llenar Solicitud" 
                    onclick="btnLlenar_Click" class="btn btn-outline-primary" Width="133px" />
